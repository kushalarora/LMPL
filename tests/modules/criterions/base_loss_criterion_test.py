...
class TestBaseLossCriterion(AllenNlpTestCase):
  def test_loss_criterion(self):
    ...
    criterion._compute_rollout_loss_batch = \
      lambda rollin_output_dict,rollout_output_dict_iter,state,target_tokens: (torch.FloatTensor([1.,3.]), torch.FloatTensor([1.,3.]), [1,2], torch.zeros((2, 2)))
  ...
  def test_rollin_rollout_mixing_coeff_should_be_bw_0_1(self):
    ...
    criterion._compute_rollout_loss_batch = \
      lambda rollin_output_dict,rollout_output_dict_iter,state,target_tokens: (torch.FloatTensor([2.,2.]), torch.FloatTensor([1.,3.]), [1,2], torch.zeros((2, 2)))
